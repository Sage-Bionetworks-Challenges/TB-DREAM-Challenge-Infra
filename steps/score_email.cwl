...
#
# Edit made by <meghasyam@sagebase.org> to change submission message to
# "Your submission has been scored and will be posted to the scoreboard within an hour."
$namespaces:
  s: https://schema.org/
        ...
        entry: |
          ...
          if status == "SCORED":
              ...
              for annot in args.private_annotations:
                del annots[annot]
              if len(annots) == 0:
                  message = "Your submission has been scored and will be posted to the scoreboard within an hour."
              else:
                  message = ["Hello %s,\n\n" % name,
